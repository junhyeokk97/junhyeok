...
model.fit(x,y, epochs=1000, batch_size=100, verbose=2, validation_split=0.2, 
                 callbacks=[es])

# path = './_save/keras28_mcp/02_california/'
# # model.save_weights(path + 'keras28_california_save2.h5')
# model.save(path + 'keras28_california_save2.h5')
...
# loss :  2.694892168045044
# rmse:  1.6416127742518118