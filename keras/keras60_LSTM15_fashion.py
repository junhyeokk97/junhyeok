...
from tensorflow.keras.layers import Dense, Conv2D, LSTM, Flatten, Dropout, MaxPooling2D,BatchNormalization, Input
import time
import numpy as np
...
aaa = np.tile(x_train[0].reshape(28*28), augment_size).reshape(-1, 28,28) # augment # of data to 'augment_size' times
print(aaa.shape)    # (40000, 28, 28)  > agment_size 만큼 x_train 1번째 이미지를 만들어낸다.
...
print(x_train.shape, y_train.shape, x_test.shape)   # (100000, 28, 28, 1) (100000,) (10000, 28, 28, 1)
