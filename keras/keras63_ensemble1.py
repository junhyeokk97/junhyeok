...
x1_train, x1_test, x2_train, x2_test, y_train, y_test = train_test_split(
    x1_datasets, x2_datasets, y, test_size=0.3, random_state=50)
...
model.fit([x1_train, x2_train], y_train ,validation_split=0.2, epochs=1000, batch_size=25,
...
print('loss: ', loss[0])
print('acc: ', loss[1])
print('예측된 y 값 (2101~2106 예상치):', y_pred.flatten().np.argmax())


# 예측된 y 값 (2101~2106 예상치):
# [2097.9812 2101.029  2104.1067 2107.1843 2110.262  2113.3396]
