...
hist = model.fit(x,y, epochs=90, batch_size=10, verbose=2, validation_split=0.1, 
                 callbacks=[es, mcp])

path = './_save/keras28_mcp/03_diabetes/'
# model.save_weights(path + 'keras28_diabetes_save2.h5')
model.save(path + 'keras28_diabetes_save2.h5')
