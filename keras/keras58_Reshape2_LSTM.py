...
# #2. 모델구성
# model = Sequential()
# model.add(Conv2D(10, (3,3), strides=1, input_shape=(28, 28, 1)))   # 26,26,10
# model.add(Reshape((26, 260)))
# model.add(LSTM(15, input_shape=(26, 260)))
# model.add(Reshape((5, 3)))
# model.add(Conv2D(filters=32, kernel_size=(3,3)))                   # 24,24,32
...
model = Sequential()
model.add(Conv2D(10, (3,3), strides=1, input_shape=(28, 28, 1)))  # (None, 26, 26, 10)
model.add(Flatten())                                             # (None, 6760)
model.add(Dense(6760))                                           # (None, 6760) - 선택사항
model.add(Reshape((26, 260)))                                    # (None, 26, 260)
model.add(LSTM(64, return_sequences=True))                       # (None, 26, 64)
