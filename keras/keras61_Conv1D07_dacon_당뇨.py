...
x = x.to_numpy().reshape(x.shape[0], x.shape[1], 1)  # (768, 8, 1)
y = y.to_numpy().reshape(y.shape[0], 1)  # (768, 1)
...
es = EarlyStopping(
    ...
    patience=32, restore_best_weights=True
)
...
# Loss   : 0.464
# Acc    : 0.7273
# 걸린시간:  3.9088032245635986

# conv1d
# Loss   : 0.3866
# Acc    : 0.8636
# 걸린시간:  9.000394821166992