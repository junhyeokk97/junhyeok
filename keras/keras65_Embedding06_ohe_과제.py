...
docs = [
    ...
    '석준이 바보', '준희 잘생겼다', '이삭이 또 구라친다','아야어여오요'
    '라랴라러려루', '쿠크카캬키캐', '마먀며머무므','우유으이에예',
]   # x data
...
print(padding_x.shape)  # (95, 35)

padding_x = padding_x.reshape(95, 7, 5)
print(padding_x.shape)  # (95, 7, 5)

x_train, x_test, y_train, y_test = train_test_split(
    padding_x, label, test_size=0.2, random_state=55
)
...
model = Sequential()
model.add(Conv1D(64, 2, input_shape=(7, 5)))
