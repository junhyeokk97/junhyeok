...
start = time.time()
history = model.fit(x_test, y_test, epochs=1000, batch_size=32, verbose=2, validation_split=0.2)
...
# Loss: 2318.589111328125
# RMSE : 48.15172683698255
# 걸린시간:  53.79797983169556
# GPU 있다.