...
from tensorflow.keras.layers import Dense, Dropout, BatchNormalization, LSTM, Flatten, Conv1D
...
model = Sequential()
model.add(Conv1D(15, 2, input_shape=(10, 1)))
model.add(Conv1D(14, 9))
model.add(Flatten())
