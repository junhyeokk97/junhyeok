...
# model.save_weights(path + 'keras28_boston_save1.h5')
...
path = './_save/keras28_mcp/01_boston/'
model.save(path + 'keras28_boston_save2.h5')
# model.save_weights(path + 'keras28_boston_save2.h5')
