...
from tensorflow.keras.layers import Dense, Conv1D, LSTM, Dropout, BatchNormalization,Flatten, MaxPooling2D
...
model = Sequential()
model.add(Conv1D(30, 2, input_shape=(9, 6)))
model.add(Conv1D(29, 8))
model.add(Flatten())
