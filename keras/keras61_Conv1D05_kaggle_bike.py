...
x = x.to_numpy().reshape(10886, 8, 1)
y = y.to_numpy().reshape(10886, 3)

x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.75, test_size=0.25, shuffle=True, random_state=123)

#2. 모델구성
model = Sequential()
model.add(Conv1D(10, kernel_size=2, input_shape=(8,1)))
model.add(Conv1D(9, 7))
model.add(Flatten())
...
# RMSE : 118.44606439308328
# R2 : 0.28422796788121313
# 걸린시간:  84.47787618637085


# RMSE : 119.17223415613317
# R2 : 0.316327567423305
# 걸린시간:  95.99921202659607