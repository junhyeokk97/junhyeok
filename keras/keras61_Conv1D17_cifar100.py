...
from tensorflow.keras.layers import Dense, LSTM, Flatten, Dropout, MaxPooling2D,BatchNormalization, Input, Conv1D
import time
import numpy as np
...
model = Sequential()
model.add(Conv1D(20, 2, input_shape=(1024, 3)))
model.add(Conv1D(19, 1023))
model.add(Flatten())
