...
from tensorflow.keras.layers import Dense, LSTM, Dropout, BatchNormalization, SimpleRNN, GRU, Bidirectional
...
model = Sequential()
model.add(Bidirectional(SimpleRNN(30), input_shape=(144,13)))
model.add(Dense(25))
...
# LSTM 
# loss:  [0.2823387384414673, 0.5996880531311035]
# RMSE:  179.28448