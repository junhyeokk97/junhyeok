...
model_01.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_02 =======================================')
model_02.compile(loss='binary_crossentropy', optimizer='adam')
model_02.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_03 =======================================')
model_03.compile(loss='binary_crossentropy', optimizer='adam')
model_03.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_04 =======================================')
model_04.compile(loss='binary_crossentropy', optimizer='adam')
model_04.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_05 =======================================')
model_05.compile(loss='binary_crossentropy', optimizer='adam')
model_05.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_06 =======================================')
model_06.compile(loss='binary_crossentropy', optimizer='adam')
model_06.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_07 =======================================')
model_07.compile(loss='binary_crossentropy', optimizer='adam')
model_07.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)

print('======================================= model_08 =======================================')
model_08.compile(loss='binary_crossentropy', optimizer='adam')
model_08.fit(x_train_noised, x_train, epochs=50, batch_size=128, validation_split=0.2, verbose=0)
