...
transf = tr.Compose([tr.Resize(56), tr.ToTensor()]) # 규격을 동일하게 맞춘다. >> 56x56
# to.Tensor = 토치텐서 바꾸기 + minmaxScaler
path = './_data/torch/'
train_dataset = MNIST(path, train=True, download=True, tranform=transf)
test_dataset = MNIST(path, train=False, download=True, tranform=transf)
