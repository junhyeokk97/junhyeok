...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_07_dacon_당뇨병_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_07_best_model.joblib')  # 가중치 저장.
...
# best_score:  0.74
# model.score:  0.6946564885496184
