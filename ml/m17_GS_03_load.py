...
#1. 데이터 
x,y,= dataset = load_diabetes(return_X_y=True)
...
model = joblib.load(path + 'm15_best_model3.joblib')
...
# 'c:\x5cStudy25\x5cml\x5cm17_GS_03_load.py' ;987ee169-26c2-4b8d-ad21-6580199b6cabmodel.score :  0.4484834572711609
# Mean Squared Error:  3081.875972565741
