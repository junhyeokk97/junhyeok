...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm18_rs_12_santander_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm18_12_best_model.joblib')  # 가중치 저장.


# 최적의 파라미터:  {'n_estimators': 500, 'max_depth': 6, 'learning_rate': 0.1}
# best_score:  0.893777873994319
# model.score:  0.8944519504659949
# r2_score:  0.8196832476893152
# time :  929