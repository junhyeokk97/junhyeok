...
print(pd.DataFrame(model.cv_results_).sort_values(
    'rank_test_score',
    ascending = True).to_csv(path + 'm18_00_rs_cv_01.csv',index = False)) 


import joblib

joblib.dump(model.best_estimator_,path + 'm18_01_best_model.joblib' )



# best_score :  0.8738270238511587
