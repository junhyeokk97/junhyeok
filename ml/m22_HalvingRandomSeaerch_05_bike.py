...
# best_score:  0.35150699615478515
# model.score:  0.3426777720451355
# r2_score:  0.3426777720451355
# time :  30

path = './_save/m15_cv_results/'
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_05_bike_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_05_best_model.joblib')  # 가중치 저장.
...
# best_score:  0.2204534829892384
# model.score:  0.28311921038218246
# r2_score:  0.28311921038218246
# time :  9
...
#              multi_strategy=None, n_estimators=None, n_jobs=None,
#              num_parallel_tree=None, random_state=None, ...)
# 최적의 파라미터:  {'min_child_weight': 3, 'learning_rate': 0.01}
# best_score:  0.2832428713408935
# model.score:  0.28251449089703196
# r2_score:  0.28251449089703196
# time :  9