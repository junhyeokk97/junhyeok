...
model = HalvingGridSearchCV(xgb, parameters, cv = kfold, # 54 * 5 = 270번 
                     ...
                     max_resources = 8708 # 데이터 행의 갯수(n_samples)
...
print(pd.DataFrame(model.cv_results_).sort_values(
    'rank_test_score',
    ascending = True).to_csv(path + 'm20_00_rs_cv_05.csv',index = False)) 
...
# best_score :  0.18036175537721433
# model.score :  0.302578976701639
# best_score :  0.18036175537721433
# model.score :  0.302578976701639
# r2 score :  0.302578976701639