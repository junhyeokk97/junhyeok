...
model = HalvingRandomSearchCV(xgb, parameters, cv=kfold,   # 54 * 5 = 270
                    ...
                    #  n_iter=11,
                      factor = 3,    # 데이터는 세 배로 늘리고, 후보군 3분의 1로.
                                    ...
                                    #       n_candidates / factor
                     min_resources = 200,  # 1 iter 때의 최소 훈련 행의 수
...
# best_score:  0.24413001537322998
# model.score:  0.2558133006095886
# r2_score:  0.2558133006095886
# time :  7041

path = './_save/m15_cv_results/'
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_12_santander_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_12_best_model.joblib')  # 가중치 저장.

# n_iterations: 4
# n_required_iterations: 4
# n_possible_iterations: 7
# min_resources_: 200
# max_resources_: 160000
...
#               num_parallel_tree=None, random_state=None, ...)
# 최적의 파라미터:  {'max_depth': 6, 'learning_rate': 0.001}
# best_score:  0.8992592592592592
# model.score:  0.8995
# acc_score:  0.8995
# time :  136
