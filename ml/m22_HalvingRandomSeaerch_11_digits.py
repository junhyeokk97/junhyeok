...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_11_digits_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_11_best_model.joblib')  # 가중치 저장.
...
# best_score:  0.927997198879552
# model.score:  0.9527777777777777
# r2_score:  0.8816723430691347
# time :  9