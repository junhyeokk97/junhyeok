...
print(np.unique(y, return_counts=True))        # (array([0, 1], dtype=int64), array([179902,  20098],
...
smote = SMOTE(random_state= seed,
              k_neighbors=4,        #default    knn 항상 y값이 존재해야한다.
...
# smote default 
# accuracy score: 0.86195
# f1 score: 0.4627359408445223