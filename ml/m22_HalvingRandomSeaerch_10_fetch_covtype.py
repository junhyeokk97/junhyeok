...
model = HalvingRandomSearchCV(xgb, parameters, cv=kfold,   # 54 * 5 = 270
                    ...
                    #  n_iter=11,
                      factor = 5,    # 데이터는 세 배로 늘리고, 후보군 3분의 1로.
                                    ...
                                    #       n_candidates / factor
                     min_resources=300,  # 1 iter 때의 최소 훈련 행의 수
...
# best_score:  0.9150463819503785
# model.score:  0.9230599403381348
# r2_score:  0.9230599403381348
# time :  762

path = './_save/m15_cv_results/'
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_10_fetch_covtype_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_10_best_model.joblib')  # 가중치 저장.
...
#              num_parallel_tree=None, random_state=None, ...)
# 최적의 파라미터:  {'learning_rate': 0.1, 'max_depth': 12, 'n_estimators': 500}
# best_score:  0.9150463811525501
# model.score:  0.9230599342792937
# r2_score:  0.9230599342792937
# time :  781
...
# 최적의 파라미터:  {'learning_rate': 0.1, 'max_depth': 12}
# best_score:  0.7967715365799422
# model.score:  0.9287367796012151
# r2_score:  0.8668053059581059
# time :  62
...
#               multi_strategy=None, n_estimators=None, n_jobs=None,
#               num_parallel_tree=None, objective='multi:softprob', ...)
# 최적의 파라미터:  {'max_depth': 12, 'learning_rate': 0.1}
# best_score:  0.7967715365799422
# model.score:  0.9287367796012151
# r2_score:  0.8668053059581059
# time :  62