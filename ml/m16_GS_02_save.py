...
# kfold = StratifiedKFold(n_splits = n_split, shuffle = True, random_state = 333) # 데이터 많으면 그냥 KFold 써도 됨
...
joblib.dump(model.best_estimator_,path + 'm15_best_model2.joblib' )
