...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm18_rs_03_diabetes_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm18_03_best_model.joblib')  # 가중치 저장.


# 최적의 파라미터:  {'min_child_weight': 3, 'learning_rate': 0.01}
# best_score:  0.3026686227700151
# model.score:  0.3472180922806034
# r2_score:  0.3472180922806034
# time :  6