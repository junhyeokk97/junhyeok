...
model = HalvingRandomSearchCV(xgb, parameters, cv=kfold,   # 54 * 5 = 270
                    ...
                    #  n_iter=11,
                      factor = 4,    # 데이터는 세 배로 늘리고, 후보군 3분의 1로.
                                    ...
                                    #       n_candidates / factor
                     min_resources=120,  # 1 iter 때의 최소 훈련 행의 수
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_03_diabetes_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_03_best_model.joblib')  # 가중치 저장.
...
# best_score:  0.3381256568623902
# model.score:  0.3839029690812624
# r2_score:  0.3839029690812624
# time :  8
...
# best_score:  0.21799207234105972
# model.score:  0.4246012013596583
# r2_score:  0.4246012013596583
# time :  5