...
print(pd.DataFrame(model.cv_results_).sort_values(
    'rank_test_score',
    ascending = True).to_csv(path + 'm22_00_rs_cv_01.csv',index = False)) 


import joblib

joblib.dump(model.best_estimator_,path + 'm22_01_best_model.joblib' )




# best_score :  0.8183965724694842
# model.score :  0.8239540745892726
# best_score :  0.8183965724694842
# model.score :  0.8239540745892726
# r2 score :  0.8239540745892726
# 걸린 시간: 4.25 초