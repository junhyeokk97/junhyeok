...
model = HalvingRandomSearchCV(xgb, parameters, cv=kfold,   # 54 * 5 = 270
                    ...
                    #  n_iter=11,
                     ...
                     max_resources=100, # 데이터 행의 개수(n_sample)
                     ) 
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score',    # rank_test_score 기준으로 오름차순 정렬.
                                                  ascending=True).to_csv(path + 'm22_hrs_08_kaggle_bank_cv_results.csv')

path = './_save/m15_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_08_best_model.joblib')  # 가중치 저장.
...
# best_score:  0.8150326797385621
# model.score:  0.7884085194049747
# accuracy_score:  0.7884085194049747
# time :  8
...
# best_score:  0.826797385620915
# model.score:  0.8486987608689066
# accuracy_score:  0.8486987608689066
# time :  5